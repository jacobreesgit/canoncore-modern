...
export default async function GroupPage({ params }: GroupPageProps) {
  ...
  const contentResult = await ContentService.getByGroup(
    params.groupId,
    session.user.id
  )
  ...
  if (!contentResult.success) {
    // Handle content loading error gracefully - could show error message or empty state
    throw new Error(`Failed to load content: ${contentResult.error}`)
  }
